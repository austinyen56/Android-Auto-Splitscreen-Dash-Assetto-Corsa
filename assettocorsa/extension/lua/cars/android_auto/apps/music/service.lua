...
return function(dt)
    ...
    if curTrack.title ~= prevTrack.title or curTrack.artist ~= prevTrack.artist or curTrack.isPlaying ~=
        prevTrack.isPlaying then
        prevTrack.title = curTrack.title
        prevTrack.artist = curTrack.artist
        prevTrack.isPlaying = curTrack.isPlaying

        -- Uncomment to show notification when another song is being played
